...
df = load_data(r"C:\Users\Jeni Pragashini\Downloads\movie\imdb_2024_movies.csv")
...
with tab2:
    ...
    selected_title = st.selectbox("Choose a movie to find similar ones:", df['Title'].unique())
